...
public class HelloWorld {
	//자바 Application(모바일이나, 웹이 아닌 일반PC에서 실행되는 APP)
	...
	//일반적으로 main 클래스가 됩니다.
	//이 메서드는 하나의 앱에서 하나의 클래스만 가질수 있습니다. 즉 시작점이 하나말 말입니다.
	//따라서 앞으로 메서드는 이렇게 표현합니다. main() 이렇게 정의만 가능합니다.
	
	public static void main(String[] bbb) {
		
		//자바스크립트의 write() 와 같은 기능 가진 메서드가 있습니다.
		//System.out.printIn("값" or 변수);
