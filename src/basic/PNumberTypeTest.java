...
public class PNumberTypeTest {
	...
	public static void main(String[] args) {
		 ...
		 * 세부 자료형을 기술하세요.
		 * 원시자료형 (p타입) -수치형(정수),수치형(실수),문자형,논리형
		 * 객체형 (R타입)
		 * 
		 * 
		 ...
		 * 1. byte by = 20; short sh = by; 문제안됌
		 * 
		 * 2. long lo = 20L; float fl = lo;
		 * 3. float f= 20; long lo2 = f; (float) = lo;
		 * 
		 * 
		 * 
		 * 
		 ...
		 * 하루를 기준으로 전체 과일수의 시간당 몇개가 생산되는지를 출력하세요
		 * 단 아래의 조건을 만족 시키세요.
