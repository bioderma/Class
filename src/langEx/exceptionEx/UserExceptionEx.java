...
class Accout{
	...
	//출금메서드 정의
	public int withdraw(int money) throws AccException { //이경우에는 throws 가 나음
		//조건절에서 인출 금액이 잔액보다 클 경우 예외를 던집니다.
		if(balance < money) {
			throw new AccException("잔액 부족 합니다" + (money - balance)
					+ "이 모자랍니다!!");
		}
