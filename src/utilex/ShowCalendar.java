...
/*
 * roll() : 필드의 값을 증가시키는 메서드.. 다른필드엔 영향 없음..
...
public class ShowCalendar {
	...
	public static void main(String[] args) {
		...
		if(input != null) {
			...
			//다음엔 1일이 무슨요일인지 찾아야함.. DAY_OF_WEEK
			start_Day_Of_week = sDay.get(Calendar.DAY_OF_WEEK);
			end_day = eDay.get(Calendar.DATE);
			
			System.out.println("SUN MON TU WE TH FR SA");
			...
			// 1. 정렬 : 10일 이전은 문자가 하나이고 이후는 2개임 
			//그래서 공백을 적절히 이용해서 정렬을 해줄 예정입니다.(2칸, 1칸)
			// 2. 일요일~토요일까지 출력후 라인을 변경해쇼ㅓ 다시 날짜를 출력해야하는데
