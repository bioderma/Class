...
public class ArrayListEx2 {
	...
	public static void main(String[] args) {
		 ...
		 * 만약 다른 객체들이 추출되어 진다면, 각 객체의 특정 메서드 등을 호출할떄 문제가 발생합니다.
		 * 때문에 instanceof 를 이용 객체의 타입을 일일이 비교하여 호출 하는 방법밖엔 없게 됩니다.
		 * 
		...
		for (int i = 0; i < terran.size(); i++) {
			Medic m = (Medic)terran.get(i); //예외뜸 
		}
